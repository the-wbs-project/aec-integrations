...
- [ ] Procurement category live (AECI-559). ~~Retract semantics shipped~~ **done** — the upstream half closed as AECI-595 and the AECi consumer shipped as AECI-882, with 214 of 216 pending retractions executed and 2 held on AECI-891. ~~The invariant guard can fire~~ **done** (AECI-592).
