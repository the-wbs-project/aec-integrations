...
**Mock at the boundary.** External services (Algolia, Resend, the telemetry transport — Datadog and/or PostHog, Linear), the network layer, the database connection. Not internal helpers.
