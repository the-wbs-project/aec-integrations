...
create table audit_log (
  ...
  action text not null, -- e.g. 'review.approved', 'product.updated'; Stage 1.5 promote ingest (AECI-297) adds 'data_object.created', 'claim.*', 'attestation.*'. Stage 2 vendor authoring (AECI-301) adds 'attestation.retracted' — supersession, one row per retracted attestation, tagged metadata.source = 'vendor-portal'
