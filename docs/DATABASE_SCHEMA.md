...
**Per-request instantiation.** Do not cache the client in Worker module scope. Construct it per request and pass it to handlers via a helper. Modeled on `apps/api/src/prisma.ts:8-20`:
