...
>
> **New metric `aeci.gsc_recrawl.queued`**, tagged `source:promote`. `docs/OBSERVABILITY.md` carries the catalogue entry and the one behaviour change this causes to the existing IndexNow refusal alert.
