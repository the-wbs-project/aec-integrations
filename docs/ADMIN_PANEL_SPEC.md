...
3. **Reconcile the Drizzle journal, then apply migrations `0010`–`0014` per tier** (§13 D1
   obligation (a)). `0013` is the repo's first table recreate and carries a **hand edit** —
