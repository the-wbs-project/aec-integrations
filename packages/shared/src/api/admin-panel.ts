 ...
 * | `cron_liveness_unavailable` | N of the thirteen crons have no `job_runs` row yet — they have not run since run recording shipped, or were added since. PostHog's no-data alerts stay the authority for "a job stopped firing" |
 ...
 * read-time ASN classification (AECI-624).
 */
