...
// AECI-807 edits them, and run the ordering precondition the change calls for.
//
...
//   node scripts/ops/2026-09-waf-prod-host-removal/snapshot.mjs --out /tmp/waf.json
//
