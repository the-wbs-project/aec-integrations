...
export class UnifiedHomePreview {
  ...
  protected readonly problem = {
    ...
    stats: [
      { figure: '≈34%', desc: 'of reviews on major platforms are estimated to be AI-generated' },
      {
        figure: '$87K',
        desc: 'a year is what vendors pay to boost their ranking on leading review sites',
      },
      {
        figure: '900+',
