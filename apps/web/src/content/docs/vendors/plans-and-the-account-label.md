...
- whether your company can claim an integration it owns that is delivered through a connector, and decide contests on one ([Owning an integration](/docs/vendors/owning-an-integration)),
...
Some things need only a seat, not a plan: managing seats, owning your integrations, adding your own links, and contesting a detail. The exception is an integration delivered through a connector: claiming one, and deciding contests on one, need a plan. See [Your seat](/docs/vendors/your-seat).

## What a plan never changes

No plan, at any price, changes:

- your position in search or in any listing,
- whether a review is published or removed,
- whether a listing exists,
- what readers see about an integration's current state, including whether the two vendors agree.
...
An approved claim starts your company's plan. See [Claiming your vendor listing](/docs/vendors/claiming-your-listing).

We bill by invoice or purchase order. There is no card payment and no online checkout. To arrange access, renew, or change anything about billing, use **Renew access** or **Ask about vendor access** in the portal, which take you to our contact page.

The portal shows your plan's status, and the end date where there is one. Before the end date, everyone with a seat and AEC Integrations get an email. Nothing changes before that date, and a plan does not lapse on its own: its status changes only when we act on it.
...
- You can no longer claim an integration delivered through a connector. One you already claimed stays claimed. Open contests on it move to AEC Integrations.
