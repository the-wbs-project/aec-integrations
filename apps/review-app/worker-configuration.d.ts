/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars false` (hash: 8a78e87f07f5675230095832db2dd2eb)
// Runtime types generated with workerd@1.20260426.1 2026-04-07 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		MCP_OBJECT: DurableObjectNamespace<import("./server/index").AeciReviewMcp>;
		...
		WF_VENDOR_ORCHESTRATOR: Workflow<Parameters<import("./server/index").VendorOrchestratorWorkflow['run']>[0]['payload']>;
		WF_VENDOR_OVERVIEW: Workflow<Parameters<import("./server/index").VendorOverviewWorkflow['run']>[0]['payload']>;
		WF_PRODUCT_OVERVIEW: Workflow<Parameters<import("./server/index").ProductOverviewWorkflow['run']>[0]['payload']>;
		WF_PRODUCT_API_CHECK: Workflow<Parameters<import("./server/index").ProductApiCheckWorkflow['run']>[0]['payload']>;
		WF_PRODUCT_MARKETPLACE: Workflow<Parameters<import("./server/index").ProductMarketplaceWorkflow['run']>[0]['payload']>;
		WF_PRODUCT_IPAAS: Workflow<Parameters<import("./server/index").ProductIpaasWorkflow['run']>[0]['payload']>;
		WF_PRODUCT_REVIEWS: Workflow<Parameters<import("./server/index").ProductReviewsWorkflow['run']>[0]['payload']>;
		WF_PRODUCT_SEARCH_DEMAND: Workflow<Parameters<import("./server/index").ProductSearchDemandWorkflow['run']>[0]['payload']>;
		WF_PRODUCT_REDDIT: Workflow<Parameters<import("./server/index").ProductRedditWorkflow['run']>[0]['payload']>;
		WF_PRODUCT_SCORE: Workflow<Parameters<import("./server/index").ProductScoreWorkflow['run']>[0]['payload']>;
		WF_PRODUCT_ORCHESTRATOR: Workflow<Parameters<import("./server/index").ProductOrchestratorWorkflow['run']>[0]['payload']>;
		WF_PRODUCT_RESEARCH: Workflow<Parameters<import("./server/index").ProductResearchWorkflow['run']>[0]['payload']>;
		WF_INTEGRATIONS_WEBSITE: Workflow<Parameters<import("./server/index").ProductIntegrationsWebsiteWorkflow['run']>[0]['payload']>;
		WF_INTEGRATIONS_IPAAS: Workflow<Parameters<import("./server/index").ProductIntegrationsIpaasWorkflow['run']>[0]['payload']>;
		WF_INTEGRATIONS_MARKETPLACES: Workflow<Parameters<import("./server/index").ProductIntegrationsMarketplacesWorkflow['run']>[0]['payload']>;
		WF_INTEGRATIONS_G2: Workflow<Parameters<import("./server/index").ProductIntegrationsG2Workflow['run']>[0]['payload']>;
		WF_INTEGRATIONS_GITHUB: Workflow<Parameters<import("./server/index").ProductIntegrationsGithubWorkflow['run']>[0]['payload']>;
		WF_INTEGRATIONS_WEB: Workflow<Parameters<import("./server/index").ProductIntegrationsWebWorkflow['run']>[0]['payload']>;
		WF_INTEGRATIONS_DISCOVERY: Workflow<Parameters<import("./server/index").ProductIntegrationsDiscoveryWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SEARCH_TOOL" | "AIRTABLE_BASE_ID" | "AIRTABLE_TABLES" | "DEFAULT_MODEL" | "AI_GATEWAY_ID" | "CF_ACCOUNT_ID" | "REPORT_FROM" | "REPORT_FROM_NAME" | "REPORT_REPLY_TO" | "REPORT_TO" | "SEARCHAPI_COST_PER_SEARCH" | "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "AIRTABLE_TOKEN" | "SUPABASE_JWT_SECRET" | "SEARCHAPI_API_KEY" | "SCRAPFLY_API_KEY">> {}
}
declare module "*.md" {
	const value: string;
