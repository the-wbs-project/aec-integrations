/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 65b4f5b83d3c379a139faff176d86f37)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		AIRTABLE_TABLES: {"tools":"tbleVEZV0H5RigtHN","vendors":"tbln8aZjwPI3Am4TF","categories":"tbl0xEW7FPousftNs","projectPhases":"tblkv9fmq2nUnjwE7","disciplines":"tbl0pNJbWBiA080o7","toolIntegrations":"tbl6PBPsGJuPcrZZi","runs":"tbl0cslFyub1M9e9W"};
		...
		WF_TOOL_OVERVIEW: Workflow<Parameters<import("./server/index").ToolOverviewWorkflow['run']>[0]['payload']>;
		WF_TOOL_API_CHECK: Workflow<Parameters<import("./server/index").ToolApiCheckWorkflow['run']>[0]['payload']>;
		WF_TOOL_MARKETPLACE: Workflow<Parameters<import("./server/index").ToolMarketplaceWorkflow['run']>[0]['payload']>;
		WF_TOOL_IPAAS: Workflow<Parameters<import("./server/index").ToolIpaasWorkflow['run']>[0]['payload']>;
		WF_TOOL_REVIEWS: Workflow<Parameters<import("./server/index").ToolReviewsWorkflow['run']>[0]['payload']>;
		WF_TOOL_SEARCH_DEMAND: Workflow<Parameters<import("./server/index").ToolSearchDemandWorkflow['run']>[0]['payload']>;
		WF_TOOL_REDDIT: Workflow<Parameters<import("./server/index").ToolRedditWorkflow['run']>[0]['payload']>;
		WF_TOOL_INTEGRATION_COUNT: Workflow<Parameters<import("./server/index").ToolIntegrationCountWorkflow['run']>[0]['payload']>;
		WF_TOOL_SCORE: Workflow<Parameters<import("./server/index").ToolScoreWorkflow['run']>[0]['payload']>;
		WF_TOOL_ORCHESTRATOR: Workflow<Parameters<import("./server/index").ToolOrchestratorWorkflow['run']>[0]['payload']>;
		WF_TOOL_RESEARCH: Workflow<Parameters<import("./server/index").ToolResearchWorkflow['run']>[0]['payload']>;
	}
}
