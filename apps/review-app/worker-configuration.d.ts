/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars false` (hash: b4b8f808266a0655cd78977ad411caef)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		WF_PRODUCT_INTEGRATION_COUNT: Workflow<Parameters<import("./server/index").ProductIntegrationCountWorkflow['run']>[0]['payload']>;
