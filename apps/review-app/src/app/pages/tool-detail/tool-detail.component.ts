    ...
    @if (tool(); as tool) {
      <div class="page-container">
        ...
        @if (activeTab() === 'details') {
          ...
          <section class="detail-section">
            ...
            <dl class="metric-grid">
              ...
              <div class="metric">
                ...
                <dd class="metric__value metric__value--emphasis">
                  @if (tool.priorityScore !== undefined) {
                    {{ tool.priorityScore | number:'1.0-1' }}
                  } @else {
                    <span class="na">N/A</span>
                  }
                </dd>
              ...
              <div class="metric">
                ...
                <dd class="metric__value">
                  @if (tool.integrationScore !== undefined) {
                    {{ tool.integrationScore | number:'1.0-1' }}
                  } @else {
                    <span class="na">N/A</span>
                  }
                </dd>
              ...
              <div class="metric">
                ...
                <dd class="metric__value">
                  @if (tool.outreachScore !== undefined) {
                    {{ tool.outreachScore | number:'1.0-1' }}
                  } @else {
                    <span class="na">N/A</span>
                  }
                </dd>
              ...
              <div class="metric">
                ...
                <dd class="metric__value">
                  @if (tool.toolDataCompleteness !== undefined) {
                    {{ formatPercent(tool.toolDataCompleteness) }}
                  } @else {
                    <span class="na">N/A</span>
                  }
                </dd>
              ...
              <div class="metric">
                ...
                <dd class="metric__value">
                  @if (tool.toolEnrichmentStatus) {
                    <span class="badge" [class]="'badge badge--' + enrichmentVariant(tool.toolEnrichmentStatus)">{{ tool.toolEnrichmentStatus }}</span>
                  } @else {
                    <span class="na">N/A</span>
                  }
                </dd>
              ...
              <div class="metric">
                ...
                <dd class="metric__value">
                  @if (tool.searchVolumeMonthly !== undefined) {
                    {{ tool.searchVolumeMonthly | number:'1.0-0' }}
                  } @else {
                    <span class="na">N/A</span>
                  }
                </dd>
              ...
              <div class="metric">
                ...
                <dd class="metric__value">
                  @if (tool.googleTrendsIndex !== undefined) {
                    {{ tool.googleTrendsIndex | number:'1.0-0' }}
                  } @else {
                    <span class="na">N/A</span>
                  }
                </dd>
              ...
              <div class="metric">
                ...
                <dd class="metric__value">
                  @if (tool.redditMentions24mo !== undefined) {
                    {{ tool.redditMentions24mo | number:'1.0-0' }}
                  } @else {
                    <span class="na">N/A</span>
                  }
                </dd>
              ...
              <div class="metric">
                ...
                <dd class="metric__value">
                  @if (tool.zapierTriggerCount !== undefined) {
                    {{ tool.zapierTriggerCount | number:'1.0-0' }}
                  } @else {
                    <span class="na">N/A</span>
                  }
                </dd>
          ...
          <!-- Integrations -->
          @if (combinedIntegrations().length) {
            <section class="detail-section">
              <div class="section-row">
                <h2 class="section-heading">
                  Integrations
                  <span class="section-count">({{ combinedIntegrations().length }})</span>
                </h2>
                <input
                  class="input section-search"
                  type="search"
                  placeholder="Search by tool, type, description…"
                  [value]="integrationSearch()"
                  (input)="onIntegrationSearch($event)"
                  aria-label="Search integrations"
                />
              </div>
              <div class="table-wrapper">
                <table class="table" aria-label="Integrations">
                  <thead>
                    <tr>
                      <th>Tool</th>
                      <th>Type</th>
                  ...
                  <tbody>
                    @for (i of filteredIntegrations(); track i.id) {
                      <tr>
                        <td>
                          @if (i.otherTool) {
                            <a [routerLink]="['/tools', i.otherTool.id]">{{ i.otherTool.name }}</a>
                          }
                        </td>
                        <td>
                      ...
                      <tr>
                        <td colspan="4" class="empty-state">No integrations match your search.</td>
                      </tr>
                    }
                  </tbody>
                </table>
