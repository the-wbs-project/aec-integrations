...
- **No pay-for-placement.** Search rankings are purely algorithmic. Paid vendor tiers affect profile *richness*, never ranking position. **Implication for design:** no visual treatment signals "promoted," "sponsored," or "verified." Active vendor access uses a neutral text label and never a trust glyph.
