...
| Stage 2.5 hardening interlude (the finishable punch list between Stage 2 and Stage 3: the AECI-636 search-ranking overhaul [evidence-gated / depth-weighted / surface-scoped — retires `integration_count`] as anchor, live-defect fixes, catalog integrity, Stage 2 close-out debt, docs de-stale sweep; **proposal — not yet seeded into Linear**) | `docs/STAGE_2_5_SPEC.md` |
